...
if __name__ == "__main__":
    deformable_conv2d = DeformableConv2d(in_dim=3, out_dim=4, kernel_size=3, padding=1, with_mask=False)
    print(deformable_conv2d(torch.randn(1, 3, 5, 7)).shape)

    deformable_conv2d = DeformableConv2d(in_dim=3, out_dim=6, kernel_size=3, padding=1,  with_mask=True)
    print(deformable_conv2d(torch.randn(1, 3, 5, 7)).shape)
