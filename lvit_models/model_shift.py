...
def vgg19_shift(use_batch_norm: bool = True, layers: str = 'Baysian_Ma', state_dict: str = None):
    ...
    if state_dict is None:
        if use_batch_norm:
            pre_weight = torch.load('/home/ai1002/vgg19_bn-c79401a0.pth',map_location='cuda')
...
if __name__ == '__main__':
    ...
    x2 = torch.roll(x, shifts=(-2, -2), dims=(1, 2))
    x3 = torch.roll(x, shifts=(2, 2), dims=(1, 2))
    print('x is', x)
    print('\nx2 is', x2)
    print('\nx3 is', x3)
