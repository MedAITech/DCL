...
class MSSRM(nn.Module):
    def __init__(self, load_weights=False, upscale='x2'):
        ...
        if not load_weights:
            ...
            pre_weight = '/home/ai1002/vgg16-397923af.pth'
            missing_keys, unexpected_keys = mod.load_state_dict(torch.load(pre_weight, map_location='cuda'), strict=False)
            z = 1
